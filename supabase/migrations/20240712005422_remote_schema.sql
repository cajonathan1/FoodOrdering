...
alter table "public"."order_items" add constraint "order_item_order_id_fkey" FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE CASCADE not valid;

alter table "public"."order_items" validate constraint "order_item_order_id_fkey";

alter table "public"."order_items" add constraint "order_item_product_id_fkey" FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE not valid;

alter table "public"."order_items" validate constraint "order_item_product_id_fkey";
